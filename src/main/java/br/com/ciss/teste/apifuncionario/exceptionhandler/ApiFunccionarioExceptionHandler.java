package br.com.ciss.teste.apifuncionario.exceptionhandler;
...
@ControllerAdvice
public class ApiFunccionarioExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleRegistroJaCadastradoException(RegistroJaCadastradoException exception, WebRequest request) {
